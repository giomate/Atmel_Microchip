 ...
 */
static inline void CS_SPI_set_pull_mode(const enum port_pull_mode pull_mode)
{
	PORTB_set_pin_pull_mode(2, pull_mode);
}

/**
 * \brief Set CS_SPI data direction
 *
 ...
 *                      (low power state)
 */
static inline void CS_SPI_set_dir(const enum port_dir dir)
{
	PORTB_set_pin_dir(2, dir);
}

/**
 * \brief Set CS_SPI level
 *
 ...
 */
static inline void CS_SPI_set_level(const bool level)
{
	PORTB_set_pin_level(2, level);
}

/**
 * \brief Toggle output level on CS_SPI
 *
 * Toggle the pin level
 */
static inline void CS_SPI_toggle_level()
{
	PORTB_toggle_pin_level(2);
}

/**
 * \brief Get level on CS_SPI
 *
 * Reads the level on a pin
 */
static inline bool CS_SPI_get_level()
{
